...
const stats = [
  ...
  { name: 'To retain natural nutrients', value: 'Minimal Processing' },
  { name: 'Supporting local farmers', value: 'Ethical Partnerships' },
  { name: 'Care you can taste and feel', value: 'Trusted Quality' },
]
